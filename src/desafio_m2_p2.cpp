 ...
 * Incluida a struct triangle, bem como modificado os arrays, conforme solicitado no desafio.
 */
...
// Criado uma struct para armazenar a posição e cor do triangulo
struct Triangle 
{
	vec3 position;
	vec3 dimensions;
...
int setupGeometry()
{
	...
	GLfloat vertices[] = {
        ...
        //Adaptado para os vertices solicitados no exercicio
		-0.1, -0.1, 0.0, // v0
		0.1, -0.1, 0.0,	 // v1
		0.0, 0.1, 0.0,	 // v2
	};
